    ...
    <Box
      ...
      sx={{
        ...
        '&::before': {
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle, rgba(134,46,156,0.06) 0%, transparent 70%)',
          pointerEvents: 'none',
        },
      }}
    >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          borderRadius: '50%',
                          background:
                            i === arr.length - 1 ? '#862e9c' : 'rgba(134,46,156,0.3)',
                          border: '2px solid',
                          borderColor: '#862e9c',
                          mb: 0.75,
                        }}
                      ...
                      <Typography
                        sx={{
                          fontSize: '0.7rem',
                          fontWeight: 700,
                          color: i === arr.length - 1 ? 'primary.main' : 'text.primary',
                        }}
                      >
                        {item.year}
                      </Typography>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 3, md: 4 } }}>
                ...
                <Box sx={{ width: '100%', height: 180, overflow: 'hidden' }}>
                  <iframe
                    ...
                    style={{
                      border: 0,
                      display: 'block',
                      filter: 'hue-rotate(260deg) saturate(0.6) brightness(0.85)',
                    }}
                    loading="lazy"
                  />
                </Box>
                <Box sx={{ p: { xs: 2, md: 2.5 } }}>
                  <InfoRow icon={PIN_ICON}>{about.location}</InfoRow>
                </Box>
              </Box>
            </RevealBox>
            ...
            <RevealBox delay={300}>
              ...
              >
                ...
                <InfoRow icon={CLOCK_ICON}>Mon &ndash; Fri &nbsp;08:00 &ndash; 18:00</InfoRow>
              </Box>
            </RevealBox>
          </Box>
        </Box>
