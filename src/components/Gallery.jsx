...
const IMAGES = Array.from({ length: products.shirtCount }, (_, i) => ({
  file: `shirt${i + 1}.jpg`,
  label: `${products.altPrefix} ${String(i + 1).padStart(2, '0')}`,
}))
...
export default function Gallery({ onClose, initialIndex = 0 }) {
  ...
  function onTouchMove(e) {
    ...
    if (isSwipe.current) e.preventDefault()
  }
  ...
  const altText = `${products.altPrefix} ${String(current + 1).padStart(2, '0')}`
