    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle, rgba(134,46,156,0.18) 0%, transparent 65%)',
      ...
      <Box
        sx={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle, rgba(174,62,201,0.18) 0%, transparent 70%)',
      ...
      <Box
        sx={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle, rgba(134,46,156,0.15) 0%, transparent 70%)',
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            {weDesign.items.map((item, i) => (
              <Box
                ...
                sx={{
                  ...
                  transition:
                    'background 0.22s, border-color 0.22s, color 0.22s, transform 0.22s, box-shadow 0.22s',
                  '&:hover': {
          ...
          <Box
            sx={{
              ...
              transition: `opacity 0.6s ease ${0.35 + weDesign.items.length * 0.055 + 0.1}s, transform 0.6s ease ${0.35 + weDesign.items.length * 0.055 + 0.1}s`,
              mt: 5,
            }}
          >
            <Typography
